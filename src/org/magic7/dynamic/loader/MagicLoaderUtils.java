...
public class MagicLoaderUtils {
	...
	public static MagicCodeLib createJavaCodeLib(String spaceName,String regionName,String methodName,String imports,String parameterNames,String methodContent) {
	...
	public static MagicCodeLib createJsCodeLib(String spaceName,String regionName,String methodName,String parameterNames,String methodContent) {
		MagicCodeLib lib = new MagicCodeLib();
		lib.setName(methodName);
		lib.setCode(methodContent);
		lib.setParameterNames(parameterNames);
	...
	public static void invokeRegionCode(String spaceName,String regionName,String methodName,Object[] params) throws Exception {
		String classPath = packagePrefix+spaceName+"."+regionName;
