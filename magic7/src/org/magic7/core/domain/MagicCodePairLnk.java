...
@Entity
@Table(name = ServiceStaticInfo.TABLE_PREFIX+"_CODE_PAIR_LNK")
public class MagicCodePairLnk {
	private static final String SEQ = ServiceStaticInfo.TABLE_PREFIX+"CodePairLnk";
	@Id
	...
	@Column(name = "CODE_LNK_ID",length = 64)
	private String codeLnkId;
	...
	public String getCodeLnkId() {
		return codeLnkId;
	}
	public void setCodeLnkId(String codeLnkId) {
		this.codeLnkId = codeLnkId;
	}
